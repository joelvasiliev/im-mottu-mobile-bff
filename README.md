...
Aqui eu implementei um método de autenticação que consome do módulo de usuários do nível anterior, configurei o Jwt com guard para proteger algumas rotas. Deixei somente de exemplo pois no desafio não estava pedindo, mas poderia proteger, por exemplo a rota para gerar pares para utilizar somente para usuários logados
